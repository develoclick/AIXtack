...
| / | 375 | foco visible con Tab | OK | 22 controles; sin contorno: ninguno |
...
| /mi-negocio | 375 | foco visible con Tab | OK | 27 controles; sin contorno: ninguno |
...
| /analisis/analizar-ventas-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /analisis/calcular-punto-de-equilibrio | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /analisis/calcular-punto-de-equilibrio | 375 | «Copiar prompt» (portapapeles permitido): «Copiado ✓» y el portapapeles = el prompt | OK | 3679 caracteres copiados |
...
| /analisis/calcular-punto-de-equilibrio | 375 | portapapeles totalmente bloqueado: aparece el texto para copiar a mano con el prompt completo | OK | 3635 caracteres |
...
| /clientes/analizar-opiniones-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /clientes/responder-consultas-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /clientes/responder-reclamos-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/calendario-de-contenido-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-afiches-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-anuncios-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-promociones-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-publicaciones-para-redes-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /negocio/documentar-procesos-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /negocio/organizar-tareas-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /ventas/calcular-precios-y-margenes | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /ventas/crear-cotizaciones-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /ventas/crear-descripciones-de-productos-con-ia | 375 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| / | 1280 | foco visible con Tab | OK | 22 controles; sin contorno: ninguno |
...
| /mi-negocio | 1280 | foco visible con Tab | OK | 27 controles; sin contorno: ninguno |
...
| /analisis/analizar-ventas-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /analisis/calcular-punto-de-equilibrio | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /analisis/calcular-punto-de-equilibrio | 1280 | «Copiar prompt» (portapapeles permitido): «Copiado ✓» y el portapapeles = el prompt | OK | 3679 caracteres copiados |
...
| /analisis/calcular-punto-de-equilibrio | 1280 | portapapeles totalmente bloqueado: aparece el texto para copiar a mano con el prompt completo | OK | 3635 caracteres |
...
| /clientes/analizar-opiniones-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /clientes/responder-consultas-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /clientes/responder-reclamos-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/calendario-de-contenido-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-afiches-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-anuncios-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-promociones-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /marketing/crear-publicaciones-para-redes-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /negocio/documentar-procesos-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /negocio/organizar-tareas-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /ventas/calcular-precios-y-margenes | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /ventas/crear-cotizaciones-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
...
| /ventas/crear-descripciones-de-productos-con-ia | 1280 | foco visible con Tab | OK | 42 controles; sin contorno: ninguno |
