...
- [ ] Crear `public/ads.txt` con el ID de editor cuando AdSense lo entregue. **Ojo:** hoy ya existe la ruta dinámica `app/ads.txt/route.ts`, que sirve `google.com, pub-1950156439970490, DIRECT, f08c47fec0942fa0` (ID heredado del sitio anterior, con esa cifra escrita en el código). Comprueba que es TU ID; si no lo es, hay que cambiarlo o quitarlo antes de postular.
...
- [ ] Biografía de Nicolas escrita y visible en «Sobre nosotros».
