    ...
    capturas: [
      {
        ...
        ancho: 889,
        alto: 624,
        leyenda: "Prueba real, con el prompt de la versión anterior de esta guía y la misma información: la primera respuesta, sin editar.",
      },
      {
        ...
        ancho: 562,
        alto: 759,
        leyenda: "Prueba real, con el prompt de la versión anterior: la primera revisión de las afirmaciones encontró una condición que faltaba.",
      },
    ],
    queCorregi: [
