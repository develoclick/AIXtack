...
Antes de responder, comprueba que cada dato de cada versión está en mis datos, que las cifras, fechas y condiciones coinciden, que hay una sola acción y que no hay promesas ni superlativos. Corrige o elimina lo que no cumpla.`,
    ...
    capturas: [
      {
        ...
        pie: "Prueba real, con el prompt de la versión anterior de esta guía y la misma información: la primera respuesta, sin editar.",
      },
      {
        ...
        etiqueta: "Prueba real",
        pie: "Prueba real, con el prompt de la versión anterior: la primera revisión de las afirmaciones encontró una condición que faltaba.",
      },
    ],
    queCorregi: [
  ...
  checklist: [
    "Cada precio, fecha, horario y condición coincide con lo que yo decidí.",
  ...
  rubros: [
    {
      rubro: "Restaurante",
      ejemplo: "Fonda El Sabor (ficticia): «Menú del día: sopa, plato de fondo y bebida por $5. De lunes a viernes, de 12:00 a 15:00. Hasta agotar existencias.» Acción: reservar por WhatsApp.",
      consejo: "Si el horario limita la oferta, va en la misma frase que el precio: es lo primero que decide si la persona viene.",
    },
    {
      rubro: "Tienda",
      ejemplo: "Boutique Aldea (ficticia): «Camisas: 2 por $15. Solo este sábado, de 10:00 a 18:00. No acumulable con otras ofertas.» Acción: pasar por la tienda.",
      consejo: "Aclara las exclusiones en el propio anuncio: «no acumulable» o «hasta agotar stock» evitan reclamos en el mostrador.",
    },
    {
      rubro: "Servicios",
      ejemplo: "Estudio de uñas Brillo (ficticio): «Manicura con diseño: $12. Martes y miércoles, con cita. Cupos limitados por día.» Acción: reservar por WhatsApp.",
  ...
  faq: [
    ...
    { p: "¿Tengo que revisar las reglas de la plataforma?", r: "Sí. Las reglas sobre descuentos, imágenes y mensajes dependen de la plataforma y de tu país, y esta herramienta no las cubre. Si no conoces los límites de texto del canal, el prompt te lo dirá en lugar de suponerlos." },
  ],
  ...
  metodoCompleto: {
    ...
    parrafos: [
      ...
      "**Pruebas reales del método anterior.** Las capturas de abajo son respuestas reales de una IA, sin editar, a los prompts encadenados de la versión anterior de esta guía con los mismos datos de Casa y Clavo. No son la respuesta a este prompt único.",
    ...
    capturas: [
      {
        ...
        etiqueta: "Prueba real",
        pie: "Prueba real, método anterior: el refuerzo de una sola palanca, con el dato que respalda cada cambio.",
      },
      {
        ...
        etiqueta: "Prueba real",
        pie: "Prueba real, método anterior: el mismo anuncio adaptado a tres canales.",
      },
      {
        ...
        etiqueta: "Prueba real",
        pie: "Prueba real, método anterior: la versión B para probar, cambiando solo el gancho.",
      },
    ],
  },
});
