...
Antes de responder, comprueba que cada dato de cada versión está en mis datos, que las cifras, fechas y condiciones coinciden, que hay una sola acción y que no hay promesas ni superlativos. Corrige o elimina lo que no cumpla.`,
  ...
  // Espacios de imagen: guarda cada archivo (.webp, .png o .jpg) con su nombre en public/img/marketing/crear-anuncios-con-ia/ y aparece solo. Ver docs/como-publicar.md.
  imagenes: [
    {
      id: "prueba-prompt-01",
      archivo: "prueba-prompt-01",
    ...
    },
    {
      ...
      alt: "Chat nuevo con el prompt único de esta página y los datos de Casa y Clavo (ficticia): las tres versiones del anuncio, la versión para WhatsApp y la lista de afirmaciones que hay que verificar. Sustituye a las capturas del método anterior.",
