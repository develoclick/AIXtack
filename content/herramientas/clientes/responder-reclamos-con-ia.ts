...
export default defineHerramienta({
  ...
  meta: {
    ...
    ogImage: "/img/clientes/responder-reclamos-con-ia/og.webp",
  },
...
Antes de responder, comprueba que cada frase con un hecho se apoya en mis hechos confirmados, que cada oferta y cada «no» coincide con lo que escribí, que no hay culpas, promesas futuras ni consejos legales y que el siguiente paso es uno solo. Corrige lo que no cumpla.`,
  ...
  // Espacios de imagen: guarda cada archivo (.webp, .png o .jpg) con su nombre en public/img/clientes/responder-reclamos-con-ia/ y aparece solo. Ver docs/como-publicar.md.
  imagenes: [
    {
      id: "prueba-01",
      archivo: "prueba-01",
      ...
      alt: "Chat nuevo: la respuesta de la IA a un reclamo de un cliente de Luz de Barrio (ficticio). Debe verse la separación entre hechos y emociones, la respuesta profesional (privada) y el siguiente paso concreto.",
