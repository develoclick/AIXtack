    ...
    <>
      ...
      <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        ...
        <p className="mt-10 max-w-2xl text-sm leading-relaxed text-muted-foreground">
          El correo lo lee {getAuthor(AUTOR_POR_DEFECTO)!.name}, responsable de {siteName}, un proyecto de {getAuthor(EDITORIAL)!.name}. Si nos escribes para proponer una herramienta, cuéntanos qué tarea de tu negocio quieres resolver y qué te lo impide hoy. Última actualización:{" "}
